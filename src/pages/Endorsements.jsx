    ...
    <div>
      ...
      <section className="relative overflow-hidden border-b border-line">
        ...
        <div className="relative mx-auto max-w-[1400px] px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-line bg-surface px-3 py-1 text-[13px] text-gray-200">
              <Heart size={13} className="text-primary-light" />
              Endorsements
            </div>
            <h1 className="mt-6 text-balance text-5xl font-semibold tracking-tightest text-white sm:text-6xl">
              Companies we're <span className="text-gradient-accent">inspired by</span>.
            </h1>
            <p className="mt-6 text-balance text-lg leading-relaxed text-gray-300">
      ...
      <section className="border-b border-line">
        <div className="mx-auto max-w-[1400px] px-4 py-20 sm:px-6 lg:px-8">
          <p className="mb-8 text-sm font-medium uppercase tracking-widest text-gray-400">
            Featured
          </p>
          <motion.div
                ...
                <TiltCard className="card glow-border card-hover h-full p-8" max={5}>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <ArrowUpRight
                        size={20}
                        className="text-gray-500 transition-all duration-200 group-hover:text-white"
                      />
                    </div>
                    <p className="mt-6 text-[15px] leading-relaxed text-gray-300">{c.blurb}</p>
                  </a>
                </TiltCard>
              </motion.div>
            ))}
              ...
              <motion.div key={c.name} variants={itemVariants}>
                <TiltCard className="card glow-border card-hover h-full p-6" max={6}>
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-gray-300">{c.blurb}</p>
                  </a>
                </TiltCard>
              </motion.div>
            ))}
